...
const HeroSection = () => {
  ...
  return (
    <section id='home' className="section mt-20 text-white block">
      <div className="home_shadow w-full h-[375px] absolute bottom-1 z-1 bg-[linear-gradient(180deg,hsla(240,100%,2%,0)_10%,hsl(240,100%,2%)_40%)] lg:h-full lg:bg-[linear-gradient(180deg,hsla(240,100%,2%,0)_60%,hsl(240,100%,2%)_80%)]"></div>
